...
import BubbleVis from "../../components/BubbleVis/pagea";
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        "https://08ac-131-112-213-64.ngrok-free.app/messages"
      );
      ...
      // アプリケーション形式に変換
      const bubbleData: BubbleType2[] =
        parsedData.messages.map(convertToAppFormat);
