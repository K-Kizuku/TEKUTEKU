...
import ReplyModal from "../replymodal/pagea";
        ...
        {(showReplies || isClosing) && (
          ...
          >
            {replyPositions.map((position, index) => {
              const reply =
                bubble.replies && index < bubble.replies.length
                  ? bubble.replies[index]
                  : null;

              const isPlusButton =
                index === getPlusButtonIndex() &&
              ...
              return (
                <div
                  key={index}
                  className={
                    isPlusButton ? styles.plusBubble : styles.replyBubble
                  }
                  style={
                    {
                      position: "absolute",
                  ...
                  onClick={
                    isPlusButton ? () => handleOpenModal(index) : undefined
                  }
                >
                  {isPlusButton ? (
